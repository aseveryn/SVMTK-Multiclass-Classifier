...
double AVA_tree_kernel_norm(KERNEL_PARM * kernel_parm, DOC * a, DOC * b) {//all_vs_all_tree_kernel
	...
	return k/sqrt(a->num_of_trees * b->num_of_trees);
}
...
double choose_tree_kernel(KERNEL_PARM *kernel_parm, DOC *a, DOC *b){
  ...
  switch(kernel_parm->vectorial_approach_tree_kernel) {
    ...
    case 'A': /* TREE KERNEL ALL-vs-ALL k11+k12+k13+..+k23+k33+..knn*/
		...
		case 'N': /* TREE KERNEL ALL-vs-ALL k11+k12+k13+..+k23+k33+..knn*/
			return (AVA_tree_kernel_norm(kernel_parm, a, b));
